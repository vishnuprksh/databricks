...
## Summary
- 114 nodes · 142 edges · 12 communities (8 shown, 2 thin omitted)
...
6. `generateSuggestions()` - 4 edges
7. `optimizeStartingEleven()` - 4 edges
8. `fetchPlayers()` - 4 edges
9. `fetchPredictions()` - 4 edges
10. `scripts` - 4 edges
